...
import com.qualcomm.vuforia.samples.SampleApplication.utils.Cylinder;
...
public class ImageTargetRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
    	...
    	cylinder = new Cylinder(mActivity);
    	cylinder.loadTexture();
    ...
    public void onDrawFrame(GL10 unused) {
	    ...
	    // Draw square
	    //cylinder.draw(mVPMatrix, mAngle);
	    cylinder.draw(modelViewProjection, mAngle);
    ...
    */
    ...
    public void toggleRotation(boolean isAutoRotation){
    	mAutoRotation=isAutoRotation;
    }
}